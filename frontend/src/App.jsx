                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                <button
                                  ...
                                  className="px-2 py-1 ml-3 text-red-400 transition-all duration-200 border rounded-lg bg-red-500/20 hover:bg-red-500/40 hover:text-red-300 border-red-500/30 hover:border-red-500/50"
                ...
                <div className="relative z-10">
                  ...
                  {results ? (
                    ...
                    <div className="py-20 text-center text-slate-400 md:py-32">
                      {error ? (
                        <div className="max-w-md p-6 mx-auto border bg-red-500/10 border-red-500/30 rounded-2xl md:p-8">
                          <p className="mb-2 text-lg text-red-300 md:text-xl">Optimization failed</p>
                          <p className="text-sm text-red-400/80 md:text-base">{error}</p>
                        </div>
                      ) : (
                        <>
